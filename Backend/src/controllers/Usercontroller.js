...
export const Signup = async (req, res) => {
  try {
    ...
    const mailResponse = await sendMail({
      ...
      htmlTemplate: `<h1>Welcome ${name} Our Diamond Managment System As a Employee</h1>`,
    });
...
export const UpdateProfile = async (req, res) => {
  try {
    ...
    const user = await Usermodle.findByIdAndUpdate(id, updateData, { new: true, runValidators: true });
